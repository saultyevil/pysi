...
def main(setup: tuple = None) -> Tuple[plt.Figure, plt.Axes]:
    ...
    if setup:
        root, cd, xmin, xmax, smooth_amount, frequency_space, common_lines, axes_scales, file_ext, display = setup
    else:
        root, cd, xmin, xmax, smooth_amount, frequency_space, common_lines, axes_scales, file_ext, display = \
            setup_script()
